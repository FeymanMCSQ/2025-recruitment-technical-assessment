...
export default function TopBarMobile() {
  ...
  return (
    <div className="w-full h-20 flex flex-row justify-between border-black border-solid border-b border-opacity-20">
      ...
      <div className="flex flex-row items-center">
        <div className="border-orange-600 border-solid border-2 p-2 rounded-md m-1">
          <FontAwesomeIcon
        ...
        <div className="border-orange-600 border-solid border-2 p-2 rounded-md	m-1 bg-orange-600">
          <FontAwesomeIcon
            icon={faBorderAll}
            height={20}
            width={20}
        ...
        <div className="border-orange-600 border-solid border-2 p-2 rounded-md	m-1 mr-3">
          <FontAwesomeIcon
            icon={faMoon}
            height={20}
            width={20}
